...
public class HBaseTest1 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            HBaseTest1.addRecord(tablename, "row1", "family1", "q1", "5");
            HBaseTest1.addRecord(tablename, "row1", "family1", "q2", "90");
            HBaseTest1.addRecord(tablename, "row2", "family2", "q1", "97");
            HBaseTest1.addRecord(tablename, "row2", "family2", "q2", "87");

            System.out.println("===========get one record========");
            HBaseTest1.getOneRecord(tablename, "scores");

            System.out.println("===========show all record========");
            HBaseTest1.getAllRecord(tablename);

            System.out.println("===========del one record========");
            HBaseTest1.delRecord(tablename, "row");
            HBaseTest1.getAllRecord(tablename);
            ...
            JavaRDD<Person> datas2 = hBaseRDD.map(new Function<Tuple2<ImmutableBytesWritable, Result>, Person>() {
                ...
                public Person call(Tuple2<ImmutableBytesWritable, Result> immutableBytesWritableResultTuple2) throws Exception {
                    ...
                    if (o != null) {
                        ...
                        person.setYearOfBirth(Bytes.toInt(result.getRow()));
